...
//        emailRequest.setRecipients(List.of(new RecipientListRouter.Recipient(savedUser.getEmail(), "Friend")));
        emailRequest.setHtmlContent("<p>Hi, welcome to Mate Flix, we are so...</p>");
        String verificationLink = "http://api/v1/auth/verify/" + savedUser.getToken();
        emailRequest.setSubject("Welcome to mate flix. kindly verify your account" + savedUser.getToken() + "or click on this link " + verificationLink);
